...
public class KeyboardTransmissionDriver implements UosDriver {
  ...
  public UpDriver getDriver() {
    UpDriver driver = new UpDriver("KeyboardTransmissionDriver");
  ...
  public void receiveRequest(ServiceCall serviceCall,
    ...
    List<DriverData> drivers = gateway.listDrivers("KeyboardReceptionDriver");
  ...
  public void stopTransmission(ServiceCall serviceCall,
    ...
    transmitting = false;
    KeyboardTransmissionDriverManager.stopTransmission();
  }
  ...
  public void closeKeyboard() {
    ...
    transmitting = false;
    try {
      gateway.callService(receiver_device, "keyboardClosed", "KeyboardReceptionDriver", null, null, new HashMap<String, Object>());
    }
    catch (ServiceCallException e) {
      e.printStackTrace();
    }
